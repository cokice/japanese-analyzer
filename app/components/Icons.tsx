...
export const Icon = {
  ...
  pencil: <I w={16}><path d="M4 20h4L19 9a2.8 2.8 0 0 0-4-4L4 16z" /><path d="m13.5 6.5 4 4" /></I>,
  arrowRight: <I w={16}><path d="M5 12h14M13 6l6 6-6 6" /></I>,
  plus: <I w={16}><path d="M12 5v14M5 12h14" /></I>,
  stop: <I w={16}><rect x="6" y="6" width="12" height="12" rx="2" /></I>,
  ...
  speakerLg: <I w={20} sw={1.6}><path d="m11 5-5 4H3.5v6H6l5 4V5Z" /><path d="M15 8.5a5 5 0 0 1 0 7M18 5.5a9 9 0 0 1 0 13" /></I>,
};
